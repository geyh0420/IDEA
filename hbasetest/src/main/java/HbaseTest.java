...
public class HbaseTest {
    ...
    static {
        ...
        configuration.set("hbase.zookeeper.quorum", "10.1.10.78");
        configuration.set("hbase.master", "10.1.10.78:60010");
    }
...
//        HTable table = (HTable) pool.getTable(tableName);
    ...
    private static void deleteByCondition(String tablename, String rowkey)  {
...
//        HTable table = (HTable) pool.getTable(tableName);
    ...
    private static void QueryByCondition2(String tableName) {
    ...
    private static void QueryByCondition3(String tableName) {
